...
clientSystem.initialize = function () {
	...
	clientSystem.registerEventData("prod:pinky", eventDataDefaults)
...
clientSystem.update = function() {
	...
	if (firstTick) {
		...
		let pinkyEventData = clientSystem.createEventData("prod:pinky");
		pinkyEventData.data.narf = true;

		clientSystem.broadcastEvent("prod:pinky", pinkyEventData);
	}
}
