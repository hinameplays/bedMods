...
clientSystem.initialize = function () {
	...
	clientSystem.registerEventData("bedcapabilities:pinky", eventDataDefaults)
...
clientSystem.update = function() {
	...
	if (firstTick) {
		...
		let pinkyEventData = clientSystem.createEventData("bedcapabilities:pinky");
		pinkyEventData.data.narf = true;

		clientSystem.broadcastEvent("bedcapabilities:pinky", pinkyEventData);
	}
}
